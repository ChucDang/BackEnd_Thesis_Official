                        ...
                        <Col>
                            <Table >
                                <tbody>
                                    <tr>
                                        <td className='product-tab__1col--item'>Loại</td>
                                        <td className='product-tab__1col--item'>{product.ram.code}</td>
                                    </tr>
                                    <tr>
                        ...
                        <Col>
                            <Table >
                                <tbody>
                                    <tr>
                                        <td className='product-tab__1col--item'>Tốc độ</td>
                                        <td className='product-tab__1col--item'>{product.ram.frequent} MHz</td>
                                    </tr>
                                </tbody>
                            </Table>
                        </Col>
                            ...
                            <Table >
                                <tbody>
                                    <tr>
                                        ...
                                        <td className='product-tab__1col--item'>{product.storage.slot}</td>
                                    </tr>
                                    <tr>
                                        <td className='product-tab__1col--item'>Còn lại</td>
                                        <td className='product-tab__1col--item'>{product.storage.remain}</td>
                                    </tr>  <tr>
